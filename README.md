...
* March 30, 2026: Updated PGS-TRI function, added PGS-TRI-centered feature for centering $\delta$-IDE using reference data.
...
-   Ziqiao Wang, Luke Grosvenor, Debashree Ray, Tianyuan Cheng, Ingo Ruczinski, Terri
    Beaty, Heather Volk, Christine Ladd-Acosta, Nilanjan Chatterjee
    (2026). Estimation of Direct and Indirect Polygenic Effects and
    Gene-Environment Interactions using Polygenic Scores in Case-Parent
    Trio Studies. Nat Genet. <https://www.nature.com/articles/s41588-026-02601-2>
