...
![](https://github.com/user-attachments/assets/a09ac2d4-3dac-4391-a31f-4bf3f7adc238)
...
[PGS-TRI](http://ziqiaow.github.io/PGS.TRI/articles/R/PGS-TRI.R). The R
function to simulate data is available here
[simulation](http://ziqiaow.github.io/PGS.TRI/articles/R/simulation.R).
We also provide the R function to run the polygenic TDT (pTDT) test
[pTDT](http://ziqiaow.github.io/PGS.TRI/articles/R/pTDT.R) (originally
proposed by Weiner et al, Nat Genet. 2017). For PGSxE analysis, the
case-only method is also implemented here
[case-only](http://ziqiaow.github.io/PGS.TRI/articles/R/case-only.R)
...
Print the final results. “Estimate” refers to log relative risk (log
RR).
