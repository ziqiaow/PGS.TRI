...
Installation in R The package can be easily installed from Github
...
Input the column names of your input data .txt file for child
(–offspring-col), mother (–mother-col), father (–father-col). Replace
path_to_package, path_to_data, path_to_result with your own directory
paths.
