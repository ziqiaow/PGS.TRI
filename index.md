...
![](https://github.com/user-attachments/assets/5630687f-dc02-45a3-a616-9b45e19ca443)
...
PGS-TRI can be run in an R session. An interactive R tutorial with
examples is provided at: [Get
started](https://ziqiaow.github.io/PGS.TRI/articles/PGS-TRI.html).
...
PGS-TRI can also be run directly from the command line without starting
an R session. Below are example codes for running PGS-TRI using command
line.
...
directory paths. Replace data.txt and results.txt with your own data and
output names.
...
- Ziqiao Wang, Luke Grosvenor, Debashree Ray, Tianyuan Cheng, Ingo
  Ruczinski, Terri Beaty, Heather Volk, Christine Ladd-Acosta, Nilanjan
  Chatterjee (2026). Estimation of Direct and Indirect Polygenic Effects
  and Gene-Environment Interactions using Polygenic Scores in
  Case-Parent Trio Studies. Nat Genet.
